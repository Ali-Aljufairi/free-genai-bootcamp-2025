...
import { BookOpen, GraduationCap, Home, LayoutDashboard, Menu, Settings, X } from "lucide-react"
    ...
    <>
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent side="left" className="p-0 w-64">
          <nav className="flex flex-col h-full bg-white/90 dark:bg-slate-900/90 paper-texture backdrop-blur-sm">
      ...
      <div className="hidden md:flex flex-col h-screen w-64 border-r bg-white/90 dark:bg-slate-900/90 paper-texture backdrop-blur-sm">
