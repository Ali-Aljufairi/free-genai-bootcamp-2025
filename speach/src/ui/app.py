...
class SpeechApp:
    ...
    def run(self):
        ...
        st.write("Record your voice to transcribe, analyze Japanese structure, and generate images.")
    ...
    def _render_audio_section(self):
        ...
        if upload_option:
            ...
            if st.button("Start Recording"):
                logger.info(f"Starting audio recording for {record_duration} seconds")
                with st.spinner(f"Recording for {record_duration} seconds..."):
                    try:
                        audio_file_path = record_and_save(duration=record_duration)
                        st.session_state.audio_file_path = audio_file_path
                        st.success(f"Recording completed!")
    ...
    def _process_audio(self):
        ...
        with st.spinner("Transcribing audio..."):
            try:
                result = self.whisper_client.transcribe_japanese(st.session_state.audio_file_path)
    ...
    def _analyze_japanese(self):
        ...
        with st.spinner("Analyzing Japanese sentence structure..."):
            try:
                result = self.groq_client.analyze_japanese_sentence(st.session_state.transcript)
